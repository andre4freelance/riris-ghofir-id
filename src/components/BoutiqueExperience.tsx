...
import { MessageCircle, Scissors, CalendarCheck, Sparkles, HelpCircle } from "lucide-react";
import { BOUTIQUE_INFO } from "../data/catalog";
import { ImageWithFallback } from "./ImageWithFallback";

export const BoutiqueExperience: React.FC = () => {
  return (
    <section id="layanan" className="py-16 sm:py-24 bg-[#FAF8F5] border-t border-[#EEEEEE]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs uppercase tracking-[0.25em] text-[#B38E5D] font-semibold flex items-center justify-center gap-1.5 mb-2">
            <Sparkles className="w-3.5 h-3.5" /> Atelier Bespoke & Fitting Journey
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="card bg-white p-8 border border-[#E8E2D5] rounded-none shadow-xs flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-full bg-[#111111] text-[#B38E5D] flex items-center justify-center mb-6 font-serif text-xl font-bold">
                01
              </div>
              ...
              <p className="text-xs sm:text-sm text-[#666666] leading-relaxed mb-4">
                Pilih siluet kebaya modern, gaun modest, atau setelan songket dari koleksi katalog showcase website kami sebagai referensi dasar.
              </p>
            </div>
            <div className="text-[11px] font-semibold uppercase tracking-wider text-[#B38E5D]">
              Eksplorasi Katalog
            </div>
          </div>
        ...
        {/* Atelier Atmosphere Feature Banner */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white border border-[#EAEAEA] p-6 sm:p-10 mb-20 shadow-xs">
          <div className="lg:col-span-6 relative aspect-[16/10] overflow-hidden bg-[#111111]">
            <ImageWithFallback
              src="/images/hero/atelier-fitting.jpg"
              alt="Suasana Atelier & Ruang Fitting Riris Ghofir Boutique Surabaya"
              aspectRatio="aspect-[16/10]"
              className="w-full h-full object-cover"
            />
            <div className="absolute top-4 left-4">
              <span className="badge badge-neutral rounded-none text-[10px] uppercase tracking-widest font-semibold bg-[#111111] text-white border-none shadow-xs">
                Surabaya Atelier
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            <span className="text-[11px] uppercase tracking-[0.25em] text-[#B38E5D] font-semibold mb-2">
              Ruang Fitting Privat & Personal
            </span>
            <h3 className="font-serif text-2xl sm:text-3xl text-[#111111] font-semibold mb-4">
              Kenyamanan Menentukan Busana Impian Anda
            </h3>
            <p className="text-sm text-[#555555] leading-relaxed mb-6">
              Di butik fisik kami di Jl. Ngagel Jaya No. 96 Surabaya, Anda dapat merasakan langsung tekstur kain, memilih paduan warna songket, dan berkonsultasi mengenai detail bordir bersama tim stylist kami.
            </p>
            <div>
              <a
                ...
                className="btn btn-neutral rounded-none px-6 py-3 bg-[#111111] hover:bg-[#B38E5D] text-white text-xs font-semibold uppercase tracking-widest border-none gap-2"
              >
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            <span className="text-xs uppercase tracking-[0.25em] text-[#B38E5D] font-semibold flex items-center justify-center gap-1.5 mb-1">
          ...
          <div className="space-y-3">
            <div className="collapse collapse-arrow bg-white border border-[#E5E5E5] rounded-none">
              ...
              <div className="collapse-title text-sm font-semibold text-[#111111] pr-10">
